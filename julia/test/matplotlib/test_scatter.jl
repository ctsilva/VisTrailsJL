"""
Test matplotlib scatter plot example: scatter.vt

Tests variable marker sizes (s parameter) with PythonSource.
"""
...
println("="^70)
println("Testing scatter.vt")
println("="^70)

# Load the .vt file
vt_path = joinpath(@__DIR__, "..", "..", "..", "examples", "matplotlib", "scatter.vt")
println("\nLoading: $vt_path")
